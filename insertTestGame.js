...
async function main() {
  ...
  try {
    ...
    const payload = {
      ...
      homeTeam: new mongoose.Types.ObjectId('687ebf79c6407a8e20ade525'),
      ...
      awayTeam: new mongoose.Types.ObjectId('687ebf79c6407a8e20ade55a'),
      awayTeamName: 'Liberty',
